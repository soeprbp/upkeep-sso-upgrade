    ...
    <main className="users-page">
      ...
      <section className="users-hero panel">
        <div>
          ...
          <h2>
            {summary.totals.matched} of {total} visible users matched
          </h2>
      ...
      <section className="users-grid">
        ...
        <article className="panel panel-lg">
          ...
          <div className="bucket-list">
            {summary.actionBuckets.map((bucket) => (
              <div
                key={bucket.label}
                className={`bucket-row bucket-${bucket.tone}`}
              >
                <div>
        ...
        <article className="panel">
          ...
          <p className="panel-copy">
            This fetches UpKeep users, checks each address against local AD,
            writes ignored detailed exports, and updates this page with
            sanitized counts.
          </p>
          {topActions.length === 0 ? (
